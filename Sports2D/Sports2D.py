...
DEFAULT_CONFIG =   {'base': {'video_input': ['demo.mp4'],
                    ...
                    'angles':   {'display_angle_values_on': ['body', 'list'],
                                ...
                                'segment_angles': [ 'Right foot',
                                                    ...
                                                    'Right forearm',
                                                    'Left forearm'],
                                'flip_left_right': True, # Deprecated, kept for backward compatibility
                    ...
                    'kinematics':{'do_augmentation': False,
                                'do_ik': False,
                                'filter_ik': False,
...
CONFIG_HELP =   {'config': ["C", "path to a toml configuration file"],
                ...
                'handle_LR_swap': ["", "correct clear temporal left/right body keypoint swaps before angle computation. false if not specified"],
